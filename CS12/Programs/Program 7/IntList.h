...
class IntList
{
    //change private to protected, this should be the ONLY alteration of this class from this assignment
    protected:
        IntNode* head;
        IntNode* tail;
    ...
    public:
        ...
        //A global friend function that outputs to the stream all of the integer values within the list
        //on a single line, each separated by a space. This function does NOT send to the stream a newline or space at the end.
        ...
        //(i.e., Do not sort the list first, assume the list is already is sorted.) This function loops through the list until
        //if finds the correct position for the new data value and then inserts the new IntNode in that location. This function
